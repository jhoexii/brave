...
#!/bin/bash
wget -O /usr/local/sbin/jho/active.sh https://braveapi.gigalife.cf/app/prem
wget -O /usr/local/sbin/jho/inactive.sh https://braveapi.gigalife.cf/app/xprem
wget -O /usr/local/sbin/jho/deleted.sh https://braveapi.gigalife.cf/app/deleted
